...
import { defaultAccount, AccountAttribute, AccountTypes, ROLE_MAPPING, ATTRIBUTES_MAPPING } from "views/Accounts/AccountModel.js"
...
const AccountTablePage = ({ location, account, setAccount }) => {
  ...
  const [types, setTypes] = useState([{key:'all', text:'All'}, ...AccountTypes]);
              ...
              <GridContainer>
                ...
                <GridItem xs={12} md={4} lg={4}>
                  <FormControl className={classes.formControl} >
                    <DropdownSelect id="account-type-select"
                      label={t("Type")}
                      value={type}
                      options={types}
